...
public class P138476 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < tangerine.length; i++) {
            a.put(tangerine[i], a.getOrDefault(tangerine[i], 0) + 1);
        }
        ArrayList<Integer> b = new ArrayList<>(a.values());
...
경화가 귤 k개를 고를 때
크기가 서로 다른 종류의 수의 최솟값을 return 하도록
solution 함수를 작성해주세요.
...
경화는 크기가 2인 귤 2개와 3인 귤 2개,
또는 2인 귤 2개와 5인 귤 2개,
또는 3인 귤 2개와 5인 귤 2개로 귤을 판매할 수 있습니다.
